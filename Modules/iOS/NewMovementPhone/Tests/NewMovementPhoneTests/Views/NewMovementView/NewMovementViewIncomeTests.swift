//
//  NewMovementViewIncomeTests.swift
//
//
...
class NewMovementViewIncomeTests: XCTestCase {
    var sut: AnyView!
    ...
    func testDefaultLayout() {
        ...
        phoneSnapshotConfigurations.forEach { configuration in
            assertSnapshot(
                ...
                testName: "NewMovementViewIncomeTests_testDefaultLayout_\(configuration.name)"
            )
        }
    }
    ...
    func testDarkLayout() {
        ...
        phoneSnapshotConfigurations.forEach { configuration in
            assertSnapshot(
                ...
                testName: "NewMovementViewIncomeTests_testDarkLayout_\(configuration.name)"
            )
        }
    }
}
