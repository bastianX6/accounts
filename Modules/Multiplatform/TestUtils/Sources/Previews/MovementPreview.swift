...
extension MovementPreview: DataSourceRead {
    public func readMovements(query _: ReadMovementsQuery) -> AnyPublisher<[Movement], Error> {
    ...
    public func readMovement(id _: UUID) -> AnyPublisher<Movement, Error> {
        return Fail<Movement, Error>(error: MovementPreviewError.other).eraseToAnyPublisher()
    }

    public func getMovementSumByCategory(query _: ReadMovementsQuery) -> AnyPublisher<[MovementsSum], Error> {
    ...
    public func getMovementSumByStore(query _: ReadMovementsQuery) -> AnyPublisher<[MovementsSum], Error> {
